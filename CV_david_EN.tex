...
\usepackage{mathabx}
\usepackage{graphicx}
  	\graphicspath{{C:/Users/David/Documents/GitHub/CV_template/Logo/}} %% genre the path for your local path
...
\newcommand{\cvaddress}{2435, Chemin Sainte-foy, app 1B,  Quebec}
...
\begin{textblock}{11.35}(9.25, 1)
	...
	\begin{ExpStatement}{09/2016}{Actual}{University Laval, Actuarial School}{course assistant}
		\item Examination Correction - Introduction to Actuarial Science I
		\item Creating exercises - Introduction to actuarial practice I
		\item Examination Correction - Financial Risk Management I
		\item Creating an Exercise Document - Financial Risk Management I
		\item \href{https://davebulaval.github.io/OTC/}{Overview} of RMarkdown and collaborative tools
	\end{ExpStatement}
	...
	\mybox{Creativity}  \mybox{Leadership} \mybox{Intellectual curiosity} \mybox{Entrepreneurship} \mybox{Hard-Worker} \\ 
	\mybox{Individualization} \mybox{Perseverance} \mybox{Critical-Thinking} \mybox{Self-educated} \mybox{Quick Leaner}\\
	\newline
	...
	Science \separator Lecture \separator Sport \separator Hockey \separator Machine Learning \separator Backpack trip \separator Finance \separator Running \separator Cinema
\end{textblock}

\end{document}

%%%%% Cover letter not finish
\newpage
